...
<template>
  <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-96 space-y-8 bg-white px-6 py-6 b-border shadow-md rounded-3xl">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="submitRegistration" method="POST">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          ...
          <div>
            <label for="confirmation" class="sr-only">Confirm password</label>
        ...
        <div class="rounded-md shadow-sm -space-y-px">
            ...
            <input id="facebook" name="facebook" type="text" required
