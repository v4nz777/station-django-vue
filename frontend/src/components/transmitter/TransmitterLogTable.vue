            ...
            <table class="">
                <thead>
                    ...
                    <tr class="text-xs font-bold w-full border-b-2">
                        <td class="px-3 border-x text-gray-700 text-left bg-green-200">HOUR</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-green-200">LINE V</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-green-200">EXT</td>
                        ...
                        <td class="px-3 border-x text-gray-700 text-right bg-sky-200">FWD</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-sky-200">RF</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-orange-200">V</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-orange-200">I</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-orange-200">FWD</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-orange-200">RF</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-red-200">Author</td>
                        <td class="px-3 border-x text-gray-700 text-right bg-red-200">Remarks</td>
                    </tr>
                </thead>
                <tbody>
