        ...
        <table class="w-full table-auto">
            <thead>
                ...
                <tr class="text-xs font-bold w-full border-b-2">
                    ...
                    <td class="border-x text-gray-700 text-right bg-green-200">LINE V</td>
                    <td class="border-x text-gray-700 text-right bg-green-200">EXT</td>
                    <td class="border-x text-gray-700 text-right bg-sky-200">V</td>
                    <td class="border-x text-gray-700 text-right bg-sky-200">I</td>
                    <td class="border-x text-gray-700 text-right bg-sky-200">FWD</td>
                    <td class="border-x text-gray-700 text-right bg-sky-200">RF</td>
                    <td class="border-x text-gray-700 text-right bg-orange-200">V</td>
                    <td class="border-x text-gray-700 text-right bg-orange-200">I</td>
                    <td class="border-x text-gray-700 text-right bg-orange-200">FWD</td>
                    <td class="border-x text-gray-700 text-right bg-orange-200">RF</td>
