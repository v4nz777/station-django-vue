<template>
    <div class="mx-auto my-3">
        ...
        <i class="h-6 w-6" :class="parentIsHovered ? 'text-white':'text-primary'"><ChipIcon/></i>
        ...
        <teleport to='body'>
            ...
            <div class="bg-white rounded-md text-start justify-start flex flex-col w-96">
                <div class="flex flex-col justify-center text-center py-4 w-full">
                    <h1 class="font-bold text-primary text-xl">Log Transmitter Status</h1>
                    <hr class="w-full">
                </div>
                <div class="w-full h-full">
                    <div class="w-full">
                        ...
                        <div class="border-t flex justify-center py-1">
                            <button class="text-contrast text-xs font-thin bg-primary rounded-sm px-1"
                                @click="copy">Copy</button>
                            <p class="text-xs italic font thin text-primary">&nbsp; if same from recent hour</p>
                        </div>
                        <div class="flex justify-center px-2 border-y py-3 text-sm">
                            ...
                            <div class="flex flex-col px-2">
                                <input class="w-24 bg-primary rounded-sm text-contrast my-1 pl-2" type="number" v-model="line_voltage">
                                <input class="w-24 bg-primary rounded-sm text-contrast my-1 pl-2" type="number" v-model="exciter">
                            </div>
                        </div>
                        ...
                        <div class="flex justify-between w-full py-3">
                            <div class="border-r flex w-full">
                                ...
                                <div class="flex flex-col px-2 w-full items-center">
                                    ...
                                    <input class="w-24 bg-primary rounded-sm text-contrast mb-1 pl-2" type="number" v-model="driver_voltage">
                                    <p class="my-1 text-sm text-primary">Driver Current:</p>
                                    <input class="w-24 bg-primary rounded-sm text-contrast mb-1 pl-2" type="number" v-model="driver_current">
                                    
                                    <p class="my-1 text-sm text-primary">Driver Forward:</p>
                                    <input class="w-24 bg-primary rounded-sm text-contrast mb-1 pl-2" type="number" v-model="driver_forward">

                                    <p class="my-1 text-sm text-primary">Driver RF:</p>
                                    <input class="w-24 bg-primary rounded-sm text-contrast mb-1 pl-2" type="number" v-model="driver_rf">
                                </div>
                            </div>
                            <div class="border-l flex w-full">
                                <div class="flex flex-col px-2 w-full items-center">
                                    <p class="my-1 text-sm text-primary">Final Voltage:</p>
                                    <input class="w-24 bg-primary rounded-sm text-contrast mb-1 pl-2" type="number" v-model="final_voltage">
                                    <p class="my-1 text-sm text-primary">Final Current:</p>
                                    <input class="w-24 bg-primary rounded-sm text-contrast mb-1 pl-2" type="number" v-model="final_current">
                                    
                                    

                                    <p class="my-1 text-sm text-primary">Final Forward:</p>
                                    <input class="w-24 bg-primary rounded-sm text-contrast mb-1 pl-2" type="number" v-model="final_forward">
                                    <p class="my-1 text-sm text-primary">Final RF:</p>
                                    <input class="w-24 bg-primary rounded-sm text-contrast mb-1 pl-2" type="number" v-model="final_rf">
                                </div>
                            </div>
                        </div>
                       
                        <div class="flex flex-col justify-center px-2 border-y py-3 text-sm">
                            <p class="my-1 text-sm text-primary">Remarks:</p>
                            <textarea v-model="remarks" cols="30" rows="5" class="border-2 shadow-l p-2">
