...
<script setup>
    ...
    import { ChevronUpIcon, ChevronDownIcon, PlusIcon,ArrowCircleRightIcon, TrashIcon, RefreshIcon } from "@heroicons/vue/solid";
    ...
    watch(()=>props.batchedItems.length,(newVal,oldVal)=>{
