    ...
    <div class="mx-auto my-3">
        ...
        <teleport to='body'>
            ...
            <div class="bg-white rounded-md text-start justify-start flex flex-col w-96">
                ...
                v-if="duration">
                    <span class="font-medium">Brown Out Duration: <span class="text-blue-500">{{duration}}</span></span>
                    <button class="border px-5 py-2 text-white bg-red-500 my-5 font-bold text-lg"
