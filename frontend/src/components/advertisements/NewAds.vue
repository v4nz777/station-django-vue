            ...
            <div class="bg-slate-800 bg-opacity-50 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0"
                ...
                <div class="w-max bg-white rounded-md text-start justify-center items-center flex flex-col">
                    ...
                    <div id="newads-scroll" class="w-full h-96 overflow-y-scroll"
                        ...
                        <!-- :BO Number: -->
                        <StringField v-if="adType == 'national'"
                            @done="setBO"
                            :default="adBO"
                            title="BO"
                            :end="adType === 'national'"
                        ...
                        <!-- :Package: -->
                        <SearchOrAdd v-if="adPricing === 'package_deal'"
                            @done="setPackage"
                            :default="adPackage"
                            title="Package"
                    ...
                    <div id="newads-scroll" class="w-full h-96 overflow-y-scroll"
                        ...
                        <div class="text-left font-normal flex flex-col px-10">
                            ...
                            <span>Amount: <span class="font-light text-primary">₱ {{adAmount}}</span></span>
                            ...
                            <div>Audio Files: <br>
                                <ul>
                                    <li>
                                        <span class="font-light text-primary text-xs" v-for="f in adAudioFiles">&nbsp;&nbsp;&nbsp;&nbsp; {{f.name}}</span>
                                    </li>
                                </ul>
                            </div>
...
<script setup>
    ...
    watch(()=>adPackage.value,async (newVal,oldVal)=> {
