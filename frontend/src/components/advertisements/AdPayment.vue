<template>
    <button class="bg-blue-900 text-white w-max px-3 py-1 rounded-xl flex items-center font-bold hover:bg-blue-500"
        :disabled="open"
        @click="togglePayment">
        <span  v-if="open" class="animate-spin h-5 w-5 border-white border-b-3 border-x-2 rounded-full"></span>
    ...
    <div v-if="open"
        ...
        <div class="flex justify-between my-1">
            ...
            <input type="text" class="focus-visible:outline-2 w-24 bg-sky-300
        ...
        <div class="flex justify-between my-1">
            ...
            <input type="date" class="focus-visible:outline-2 w-24 bg-sky-300
                                        focus-within:outline-sky-500 font-thin text-sm px-2 py-1 shadow-md rounded-r-md
                                        text-sky-900 focus-within:bg-sky-100"
                                        v-model="orDate">
        </div>
        <div class="flex justify-end my-3">
            <button class="text-white font-bold rounded-md px-2 py-1"
