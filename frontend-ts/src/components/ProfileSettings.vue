<template>
  <div class="absolute top-2 right-2">
    <button @click="open = true">
      <i class="inline-block w-6 h-6 text-red-400 hover:text-red-500"
        ><CogIcon
      /></i>
    </button>
    <teleport to="body">
      <div v-if="open">
        ...
        >
          ...
          >
            ...
            <button
              class="bg-red-500 px-7 py-2 ml-2 rounded-md text-md text-white font-semibold disabled:bg-red-300"
              :disabled="!save"
