    ...
    >
      ...
      <div class="w-auto h-3/4 bg-white p-5 overflow-y-auto none-scroll">
        ...
        <div class="my-2">
          ...
          <input
            type="text"
            class="border shadow-md focus-within:outline-primary text-primary px-1 font-thin"
        ...
        <div class="my-2">
          ...
          <div class="w-full flex gap-3">
            <input
              type="number"
              class="w-12 border shadow-md focus-within:outline-primary text-primary px-1 font-thin"
              @change="describe"
...
const describe = () => {
  description.value = `${durationOfPricing.value} ${
    pricing.value + (durationOfPricing.value > 1 ? "s" : "")
  } contract. For ₱${price.value}.`;
};
