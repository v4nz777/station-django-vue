      ...
      >
        ...
        >
          ...
          <div class="flex flex-col justify-center my-5 w-56 mx-auto mb-8">
            ...
            <input
              type="datetime-local"
              class="text-gray-500 font-thin bg-secondary text-sm px-3 py-1 mt-2 rounded-md mb-5"
              v-model="datetime"
            />
          </div>
          <hr />
          ...
          >
            <button
              class="border px-5 py-2 text-white my-5 font-bold text-lg"
