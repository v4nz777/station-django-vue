<template>
  <div class="relative">
    ...
    >
      <i
        class="h-6 w-6"
        :class="parentIsHovered ? 'text-white' : 'text-emerald-500'"
        ><RectGroupIconOutline
      /></i>
    </button>
  </div>
  <teleport to="body">
    ...
    >
      ...
      <div
        id="inventory-scroll"
        class="w-inventory-add h-52 bg-white overflow-y-scroll pb-8 flex flex-col items-center justify-between"
      >
        <p class="m-3 font-bold">ADD NEW GROUP</p>
        ...
        <div class="px-6 my-3">
          <div class="w-64 relative">
            <input
              ...
              :class="
                taken
                  ? 'focus-within:outline-red-500 text-red-500'
                  : 'focus-within:outline-primary text-primary'
              "
              @keyup="checkGroup()"
            />
          </div>
